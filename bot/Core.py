...
helpcommand = ".정보 (봇 정보를 확인합니다)\n.크레딧 (크레딧을 확인합니다)\n.eval [값] (eval 함수)\n.reload {모듈이름} (모듈을 리로드합니다)\n.load {모듈이름} (모듈을 로드합니다)\n.unload {모듈이름} (모듈을 언로드합니다)\n.청소 {청소할 메시지 수} (메시지를 청소합니다. 입력을 하지 않으면 모두 청소됩니다.)\n.밴 [유저 맨션, 아이디, 이름 셋중 아무거나] {사유} (유저를 밴합니다)\n.언밴 [유저 맨션, 아이디, 이름 셋중 아무거나] (유저를 언밴합니다)\n.킥 [유저 맨션, 아이디, 이름 셋중 아무거나] {사유} (유저를 킥합니다)\n.타임아웃 [유저 맨션, 아이디, 이름 셋중 아무거나] [분] (유저를 타임아웃합니다)\n.타임아웃해제 [유저 맨션, 아이디, 이름 셋중 아무거나] (유저를 타임아웃 해제합니다)\n\n여기서 []는 필수, {}는 선택, ()는 설명을 나타냅니다."
